...
public class Criar
{
  ...
  public static ItemStack add(Material m, String nome, String[] lore, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3, Enchantment enchant4, int lvl4, Enchantment enchant5, int lvl5)
  {
    ItemStack item = new ItemStack(m);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
  ...
  public static ItemStack add(Material m, String nome, String[] lore, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3, Enchantment enchant4, int lvl4, Enchantment enchant5, int lvl5, Enchantment enchant6, int lvl6, Enchantment enchant7, int lvl7)
  {
    ItemStack item = new ItemStack(m);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
    ...
    item.addUnsafeEnchantment(enchant7, lvl7);
    ItemMeta meta = item.getItemMeta();
    meta.setLore(Arrays.asList(lore));
    meta.setDisplayName(nome);
    item.setItemMeta(meta);
  ...
  public static ItemStack add(Material m, String nome, String[] lore, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3,  Enchantment enchant4, int lvl4, int quantidade)
  {
	ItemStack item = new ItemStack(m, quantidade);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
  ...
  public static ItemStack getNamedSkull(String nick, String nome, String[] lore, int quantidade)
  {
